...
- **🔐 敏感文件保护** - 更新 `.gitignore`，防止 cookies、配置、统计等敏感文件上传到 GitHub
...
#### v3.8.1 - 主题系统 + 骨架屏 + 体验优化（2025-10-31）
...
- **🌐 更新源优化** - 移除失效镜像加速地址，直连GitHub官方，提升稳定性
...
- **🐛 修复版本号显示** - 从GitHub远程读取最新版本号，旧版本也能正确显示最新版本
