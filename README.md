...
### ⭐ 应用内更新系统（全新功能！）
- **🔄 Web界面一键更新** - 无需重新部署，点击即可更新
- **📦 版本信息显示** - 实时显示当前版本和最新版本
- **🔍 智能更新检测** - 自动对比GitHub最新commit
- **📝 更新日志查看** - 显示最近20条更新记录
- **🛡️ 安全保护机制** - 自动备份配置，更新失败自动回滚
- **⚡ 零停机更新** - 更新后重启即可，无需重新配置
...
2. **检查更新** - 点击"🔍 检查更新"按钮，查询GitHub最新版本
3. **查看更新日志** - 点击"🔄 刷新日志"查看最近20条更新记录
4. **执行更新** - 如有新版本，点击"⬇️ 立即更新"
5. **重启服务** - 更新成功后执行 `docker-compose restart`
...
**版本**：v3.4 | **更新**：2025-10-05 | **新增**：应用内更新系统
